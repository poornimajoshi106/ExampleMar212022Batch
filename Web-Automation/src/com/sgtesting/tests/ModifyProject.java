...
public class ModifyProject {
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("Flipcart");
			Thread.sleep(500);
	...
	private static void createProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("projectPopup_projectNameField")).sendKeys("Mobile Application");
			Thread.sleep(500);
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(500);
			oBrowser.findElement(By.xpath("//*[@id=\"taskListBlock\"]/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys("Web application");
			Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();
