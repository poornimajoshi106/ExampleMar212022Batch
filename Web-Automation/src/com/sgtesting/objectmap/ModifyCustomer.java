...
public class ModifyCustomer {
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("addcustomername")).sendKeys("City Bank");
			Thread.sleep(500);
	...
	private static void modifyCustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("editcustomer")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("custometclear")).clear();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("custometclear")).sendKeys("Canara Bank");
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("anywhereclick")).click();
			Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();
